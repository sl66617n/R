...
# different bones with the same (non)dominance have higher correlation 
# than same pair of bones but different (non)dominance
...
# all indices pairs have positive correlation, EU stock market are postively correlated
```
